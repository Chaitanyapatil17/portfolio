...
const projects = [
  {
    title: "RajgiraWala",
    image: rajgirawala,
    link: "https://github.com/Chaitanyapatil17/RajgiraWala2",
    preview: "https://rajgirawala.netlify.app/",
...
const Projects = () => {
  return (
    <section id="projects" className="py-12 border-t border-[#ffffff10] text-white">
      <div className="max-w-5xl mx-auto">
          ...
          {projects.map((project, index) => (
            <div key={index} className="group">
              <a href={project.preview} target="_blank" rel="noopener noreferrer" className="block">
                <div className="rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition duration-300 mb-4">
                  <img
                    src={project.image}
                    alt={project.title}
                ...
                <div className="flex items-center px-3">
                  ...
                  <div className="flex gap-2 ml-auto">
                    <a
                      href={project.link}
                      target="_blank"
                      className="w-12 h-12 flex justify-center items-center text-gray-300 hover:text-white border border-gray-600 p-3 rounded-xl bg-[#1414149c] hover:bg-gray-600"
                    >
        ...
        <a
          ...
          className="w-full flex items-center justify-center gap-2 mt-9 text-gray-300 hover:text-white border border-gray-600 p-3 rounded-full bg-[#1414149c] hover:bg-gray-600 hover:scale-105 transition"
        >
